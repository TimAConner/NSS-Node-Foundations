...
--1. Modify the previous query to also display the title of the album.SELECT MAX(s.songLength) "Duration", s.title "Song", a.title "Album"
FROM Song AS s
LEFT JOIN Album AS a ON a.albumId = s.albumId;